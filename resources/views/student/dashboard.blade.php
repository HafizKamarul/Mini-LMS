<x-app-layout>
    <x-slot name="header"><h1 class="h4 mb-0">Student Dashboard</h1></x-slot>

    <div class="row g-3 mb-4">
        <div class="col-md-3"><div class="card"><div class="card-body"><div class="text-muted small">Available Exams</div><div class="h3 mb-0">{{ $availableExams->count() }}</div></div></div></div>
        ...
        <div class="col-md-3"><div class="card"><div class="card-body"><div class="text-muted small">Completed</div><div class="h3 mb-0">{{ $completedExams->count() }}</div></div></div></div>
        <div class="col-md-3"><div class="card"><div class="card-body"><div class="text-muted small">Average Score</div><div class="h3 mb-0">{{ $averageScore !== null ? $averageScore . '%' : '—' }}</div></div></div></div>
    </div>

    <div class="card mb-4"><div class="card-header">Available Exams</div><div class="card-body">
    ...
    <div class="card mb-4"><div class="card-header">Upcoming Exams</div><div class="card-body">
    ...
    <div class="card"><div class="card-header">Completed Exams</div><div class="table-responsive"><table class="table mb-0"><thead><tr><th>Exam</th><th>Score</th><th>Status</th><th>Submitted</th><th></th></tr></thead><tbody>
